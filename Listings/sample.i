...
# 36 "Source/sample.c" 2
# 1 "./Source/Game_graphics\\game_graphics.h" 1
# 12 "./Source/Game_graphics\\game_graphics.h"
void DrawMaze();
...
int main(void)
{
 ...
 DrawBlinky(blinky.x, blinky.y, 0xF800);

 //TIME HUD
 GUI_Text(5, 280 // 28*PIXEL_SIZE, (uint8_t *) "TIME", 0xFFFF, 0x0000);
 updateTimeHUD(TIMER);

 //SCORE HUD
 GUI_Text(90, 280 // 28*PIXEL_SIZE, (uint8_t *) "Score", 0xFFFF, 0x0000);
 GUI_Text(100, 300 // 280 // 28*PIXEL_SIZE +20, (uint8_t *) "0", 0xFFFF, 0x0000);

 //LIVES HUD
 GUI_Text(190, 280 // 28*PIXEL_SIZE, (uint8_t *) "Lives", 0xFFFF, 0x0000);
 updateLifeHUD(LIVES);

 GUI_Text(70, 120, (uint8_t *) "PRESS INT0", 0xFFE0, 0x0000);
 GUI_Text(70, 134, (uint8_t *) " TO START ", 0xFFE0, 0x0000);
