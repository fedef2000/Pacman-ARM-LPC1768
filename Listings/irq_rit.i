...
{
 time_semibiscroma = (unsigned int)(0x17D7840 * 1 * 1.0f / 64.0f + 0.5), // 1/128
 time_biscroma = (unsigned int)(0x17D7840 * 1 * 1.0f / 32.0f + 0.5), // 1/64
 time_semicroma = (unsigned int)(0x17D7840 * 1 * 1.0f / 16.0f + 0.5), // 1/32
 time_croma = (unsigned int)(0x17D7840 * 1 * 1.0f / 8.0f + 0.5), // 1/16
 time_semiminima = (unsigned int)(0x17D7840 * 1 * 1.0f / 4.0f + 0.5), // 1/4
 time_minima = (unsigned int)(0x17D7840 * 1 * 1.0f / 2.0f + 0.5), // 1/2
 time_semibreve = (unsigned int)(0x17D7840 * 1 * 1.0f + 0.5), // 1
 time_three_quarters = (unsigned int)(0x17D7840 * 1 * 1.0f * 3.0f / 4.0f + 0.5), // 3/4
} NOTE_DURATION;
...
# 31 "Source/RIT/IRQ_RIT.c"
extern _Bool gameOverBool;
...
extern _Bool PAUSE;
extern _Bool collision, gameNotStarted;
int downk1 = 0;
