# 1 "Source/Game_graphics/Game_graphics.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Game_graphics/Game_graphics.c" 2
# 11 "Source/Game_graphics/Game_graphics.c"
...
void LCD_DrawGhost(uint16_t startX, uint16_t startY, uint16_t color);
# 12 "Source/Game_graphics/Game_graphics.c" 2
# 1 "./Source/Configurations\\configuration.h" 1
# 11 "./Source/Configurations\\configuration.h"
# 1 "C:\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdbool.h" 1 3
# 12 "./Source/Configurations\\configuration.h" 2
//DIRECTIONS
...
void checkVictory();
void checkNewLife();
_Bool Teleport(Sprite *player, _Bool isPacman);
void checkPills(int nextX, int nextY);
void gameOver();
void handlePause();
void checkMode();
_Bool checkCollision(Sprite *blinky, Sprite *pacman, _Bool inv);
# 13 "Source/Game_graphics/Game_graphics.c" 2
...
# 14 "Source/Game_graphics/Game_graphics.c" 2
...
extern int Matrix[];
# 30 "Source/Game_graphics/Game_graphics.c"
...
# 50 "Source/Game_graphics/Game_graphics.c"
void DrawPill(int x, int y)
{
 x=x*10;
 y=y*10;
 LCD_SetPoint(x + 4, y + 4, 0xFFFF);
 LCD_SetPoint(x + 4, y + 5, 0xFFFF);
 LCD_SetPoint(x + 5, y + 4, 0xFFFF);
 LCD_SetPoint(x + 5, y + 5, 0xFFFF);
}
# 68 "Source/Game_graphics/Game_graphics.c"
void DrawPowerPill(int x, int y)
{
 ...
 y=y*10;
    ...
    // Left dome of pill
    LCD_SetPoint(x + 2, y + 3, 0xF800);
    LCD_SetPoint(x + 1, y + 4, 0xF800);
    LCD_SetPoint(x + 1, y + 5, 0xF800);
    LCD_SetPoint(x + 2, y + 6, 0xF800);
    uint16_t i;
    // Main body of pill
    for(i = 3; i <= 6; i++) {
        LCD_SetPoint(x + 2, y + i, 0xF800);
        LCD_SetPoint(x + 3, y + i, 0xF800);
        LCD_SetPoint(x + 4, y + i, 0xF800);
        LCD_SetPoint(x + 5, y + i, 0xF800);
        LCD_SetPoint(x + 6, y + i, 0xF800);
        LCD_SetPoint(x + 7, y + i, 0xF800);
    }

    // Right dome of pill
    LCD_SetPoint(x + 7, y + 3, 0xF800);
    LCD_SetPoint(x + 8, y + 4, 0xF800);
    LCD_SetPoint(x + 8, y + 5, 0xF800);
    LCD_SetPoint(x + 7, y + 6, 0xF800);

    // 0xFFFF highlight (to give 3D effect)
    LCD_SetPoint(x + 2, y + 3, 0xFFFF);
    LCD_SetPoint(x + 3, y + 3, 0xFFFF);
    LCD_SetPoint(x + 4, y + 3, 0xFFFF);
}
# 109 "Source/Game_graphics/Game_graphics.c"
void DrawMaze()
{
...
# 133 "Source/Game_graphics/Game_graphics.c"
extern _Bool invincibility;
void DrawPacman(int x, int y){
 x = x*10;
 y = y*10;
 LCD_DrawCirle(x, y, 0xFFE0);
}
# 147 "Source/Game_graphics/Game_graphics.c"
void DrawPause(){
 DrawPixel(7, 12, 0xF800);
 DrawPixel(8, 12, 0xF800);
 DrawPixel(9, 12, 0xF800);
 DrawPixel(10, 12, 0xF800);
 DrawPixel(11, 12, 0xF800);
 DrawPixel(12, 12, 0xF800);
 DrawPixel(13, 12, 0xF800);
 DrawPixel(14, 12, 0xF800);

 DrawPixel(7, 13, 0xF800);
 DrawPixel(8, 13, 0xF800);
 DrawPixel(9, 13, 0xF800);
 DrawPixel(10, 13, 0xF800);
 DrawPixel(11, 13, 0xF800);
 DrawPixel(12, 13, 0xF800);
 DrawPixel(13, 13, 0xF800);
 DrawPixel(14, 13, 0xF800);

 DrawPixel(7, 14, 0xF800);
 DrawPixel(8, 14, 0xF800);
 DrawPixel(9, 14, 0xF800);
 DrawPixel(10, 14, 0xF800);
 DrawPixel(11, 14, 0xF800);
 DrawPixel(12, 14, 0xF800);
 DrawPixel(13, 14, 0xF800);
 DrawPixel(14, 14, 0xF800);
 GUI_Text(90, 125, (uint8_t *) "PAUSE", 0x0000, 0xF800);
}
# 184 "Source/Game_graphics/Game_graphics.c"
void EreasePause(){
 DrawPixel(7, 12, 0x0000);
 DrawPixel(8, 12, 0x0000);
 DrawPixel(9, 12, 0x0000);
 DrawPixel(10, 12, 0x0000);
 DrawPixel(11, 12, 0x0000);
 DrawPixel(12, 12, 0x0000);
 DrawPixel(13, 12, 0x0000);
 DrawPixel(14, 12, 0x0000);

 DrawPixel(7, 13, 0x0000);
 DrawPixel(8, 13, 0x0000);
 DrawPixel(9, 13, 0x0000);
 DrawPixel(10, 13, 0x0000);
 DrawPixel(11, 13, 0x0000);
 DrawPixel(12, 13, 0x0000);
 DrawPixel(13, 13, 0x0000);
 DrawPixel(14, 13, 0x0000);

 DrawPixel(7, 14, 0x0000);
 DrawPixel(8, 14, 0x0000);
 DrawPixel(9, 14, 0x0000);
 DrawPixel(10, 14, 0x0000);
 DrawPixel(11, 14, 0x0000);
 DrawPixel(12, 14, 0x0000);
 DrawPixel(13, 14, 0x0000);
 DrawPixel(14, 14, 0x0000);
}
# 220 "Source/Game_graphics/Game_graphics.c"
void updateLifeHUD(int lives){
  char result[12];
  snprintf(result, sizeof(result), "%d%s", lives, " ");
  GUI_Text(200, 300 // 280 // 28*10 +20, (uint8_t *) result, 0xFFFF, 0x0000);
}
# 233 "Source/Game_graphics/Game_graphics.c"
void updateScoreHUD(int score){
  char result[12];
  snprintf(result, sizeof(result), "%d%s", score, " ");
  GUI_Text(100, 300 // 280 // 28*10 +20, (uint8_t *) result, 0xFFFF, 0x0000);
}
# 246 "Source/Game_graphics/Game_graphics.c"
void updateTimeHUD(int time){
  char result[20];
 snprintf(result, sizeof(result), "%d%s", time, "s ");
 GUI_Text(10, 300 // 280 // 28*10 +20, (uint8_t *) result, 0xFFFF, 0x0000);
}
# 259 "Source/Game_graphics/Game_graphics.c"
void drawVictory(){
 GUI_Text(80, 125, (uint8_t *) "Victory!", 0xFFE0, 0x0000);
}
...
void DrawGameOver() {
 LCD_Clear(0x0000);
  GUI_Text(80, 130, (uint8_t *) "   GAME   ", 0xF800, 0x0000);
 GUI_Text(80, 145, (uint8_t *) "   OVER   ", 0xF800, 0x0000);
}
